...
<body class="bg-dark">
    <header class="d-flex flex-column flex-md-row align-items-center justify-content-between p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
        ...
        ?>
        <p class="h5 my-0 me-md-auto fw-normal">Фильмы, выпущенные <?= $period . ' ' . $_POST['book_year'] ?> г.</p>
        <a class="btn btn-outline-primary" href="queries.php">Назад</a>
    </header>
    <div class="container">
        <?php
        require('connect_db.php');
        $sql = 'SELECT * FROM book WHERE year ' . $_POST['period'] . ' ' . $_POST['book_year'] . ' ORDER BY year DESC';
        ?>
