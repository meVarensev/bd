...
<body class="bg-dark"> 
  <header class="d-flex flex-column flex-md-row align-items-center justify-content-between p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
    <p class="h5 my-0 me-md-auto fw-normal">Количество комментариев к фильмам</p>
  ...
  <div class="container"> 
    ...
    <?php 
        ...
        $sql = 'SELECT m.title, COUNT(r.id) AS count FROM book m JOIN review r 
                ON r.book_id=m.id
                GROUP BY m.title
        ';
    ?>  
      ...
      <div class="col-md-12">
          <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
              <div class="col p-4 d-flex flex-column position-static">
                  ...
                  <br>
                  <p class="text-light"><b>Количество комментариев: <?=$row->count?></b></p>
              </div>
          </div>
      </div>
      <?php endwhile?>
